...
export const Footer = () => {
    ...
    const displayList = data?.products && data.products.length > 0
        ? data.products.map((p) => ({
            title: p.name,
            slug: p.slug
        }))
        ...
        <footer id="footer">
                ...
                <Container className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-x-12 gap-y-8">
                    <div className="col-span-full xl:col-span-2">
                        ...
                        <p className="text-muted-foreground">
                            HISD3 helps you centralize your product, sales, and user data - all in one simple, real-time dashboard built for growing businesses.
                        </p>
                        <div className="mt-4">
                            ...
                            <div className="flex gap-2 mt-4">
                                ...
                                >
                                    <img src="/facebook.svg" alt="" className="h-8 w-8" />
                                </a>
                                <a
                                    rel="noreferrer noopener"
                                    href="#"
                                ...
                                <a
                                    ...
                                    className="opacity-60 hover:opacity-100"
                                >
                                    <img src="/telegram.svg" alt="" className="h-8 w-8" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-span-full xl:col-span-2">
                        ...
                        <div className="text-muted-foreground hover:text-foreground">
                            2/F F & L Centre 2211 Commonwealth Avenue Brgy. Holy Spirit, Quezon City, Philippines 1127
                        </div>
            ...
            <Section size="none" className="pb-14">
                <Container className="text-center">
                    <h3>
                        &copy; 2026 <span className="text-primary transition-all border-primary hover:border-b-2">HISD3 Inc.</span> All rights reserved | Built to digitize healthcare facilities{" "}
                    </h3>
                </Container>
            </Section>
        </footer>
